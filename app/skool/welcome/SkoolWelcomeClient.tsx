...
export default function SkoolWelcomeClient() {
        ...
        <div className="section-container mt-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-beige-200 font-light leading-relaxed max-w-xl mx-auto mb-10">
              Welcome to the Talent Mucho community ~ where creators and
              entrepreneurs learn to work smarter with AI. Here&apos;s what to
              do next.
            </p>

            {member?.email && (
              <p className="text-sm text-beige-300/50 font-light mb-6 -mt-4">
                Confirmation going to{" "}
                <span className="text-beige-200">{member.email}</span>
              </p>
            )}
            ...
            <div className="flex flex-col gap-6">
              {nextSteps.map(({ step, title, body, cta }) => (
                <div
                  ...
                  style={
                    step === "01" ? { borderColor: "rgba(180,120,90,0.3)" } : {}
                  }
                >
                  <span
                  ...
                  <div className="flex flex-col gap-3 flex-1">
                    <p className="font-semibold text-charcoal-900 text-base">
                      {title}
                    </p>
              ...
              {[
                {
                  ...
                  desc: "Monthly sessions with Abie and Meri",
                },
                {
                  label: "Full replays",
                  desc: "Every session on demand, forever",
                },
                {
                  label: "Community chat",
                  desc: "Ask questions, share wins, get unstuck",
                },
                {
                  label: "Early access to bootcamps",
                  desc: "First in line before doors open to the public",
                },
                {
                  label: "Inner circle",
                  desc: "Direct line to Abie & Meri and the team ~ not a ticketing system",
                },
                {
                  label: "Vibe coding sessions",
                  desc: "Build real things with AI ~ no experience needed",
                },
                {
                  label: "Resources & templates",
                  desc: "Prompts, playbooks, and tools that actually work",
                },
              ].map(({ label, desc }) => (
                <div
                  key={label}
                ...
                >
                  <p className="text-beige-50 font-semibold text-sm mb-1">
                    {label}
                  </p>
